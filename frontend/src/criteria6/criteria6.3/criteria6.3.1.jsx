...
const Criteria6_3_1 = () => {
  const [metrics, setMetrics] = useState([
    {
      id: '6.3.1',
      description: 'Provide the list of existing welfare measures for teaching and non-teaching staff within a maximum of 500 words',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">6.3.1 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              The institution has effective welfare measures for teaching and non-teaching staff </p>
