...
const Criteria6_4_1 = () => {
  ...
  const [metrics, setMetrics] = useState([
    {
      id: '6.4.1',
      description: 'Enumerate the various internal and external financial audits carried out during the last five years with the mechanism for settling audit objections within a maximum of 500 words',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex flex-1 overflow-hidden pt-8">
        ...
        <div className={`flex-1 transition-all duration-300 overflow-y-auto ${isSidebarCollapsed ? 'ml-16' : 'ml-64'} pl-6 pr-6 `}>
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center h-[70px] w-[700px] shadow border border-black/10 rounded-2xl hover:shadow-lg transition-shadow duration-300">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">6.4 Financial Management and Resource Mobilization</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">6.4.1 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              Institution conducts internal and external financial audits regularly</p>
