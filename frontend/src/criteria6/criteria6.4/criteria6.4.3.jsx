...
const Criteria6_4_3 = () => {
  ...
  const [metrics, setMetrics] = useState([
    {
      id: '6.4.3',
      description: 'Describe the resource mobilisation policy and procedures of the Institution within a maximum of 500 words',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex flex-1 overflow-hidden pt-8">
        ...
        <div className={`flex-1 transition-all duration-300 overflow-y-auto ${isSidebarCollapsed ? 'ml-16' : 'ml-64'} pl-6 pr-6 `}>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">6.4.3 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              Institutional strategies for mobilisation of funds and the optimal 
utilisation of resources</p>
