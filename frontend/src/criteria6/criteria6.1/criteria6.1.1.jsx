...
const Criteria6_1_1 = () => {
  ...
  const [metrics, setMetrics] = useState([
    {
      id: '6.1.1',
      description: 'Describe the vision and mission statement of the institution on the nature of governance, perspective plans and participation of the teachers in the decision making bodies of the institution within a maximum of 500 words',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex flex-1 overflow-hidden pt-8">
        ...
        <div className={`flex-1 transition-all duration-300 overflow-y-auto ${isSidebarCollapsed ? 'ml-16' : 'ml-64'} pl-6 pr-6 `}>
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center h-[70px] w-[700px] shadow border border-black/10 rounded-2xl hover:shadow-lg transition-shadow duration-300">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">6.1 Institutional Vision and Leadership</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">6.1.1 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              The governance of the institution is reflective of and in tune with the 
vision and mission of the institution </p>
            <h4 className="text-blue-600 font-medium mb-2">Required Documents:</h4>
            <ul className="list-disc pl-6 text-sm text-gray-700 space-y-1">
              
              <li>Paste link for additionl information</li>
              <li>Upload any addditional information</li>
            </ul>
          </div>
