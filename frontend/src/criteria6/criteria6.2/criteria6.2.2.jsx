...
const Criteria6_2_2 = () => {
  const [metrics, setMetrics] = useState([
    {
      id: '6.2.2',
      description: 'Describe the Organogram of the Institution within a maximum 500 words',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">6.2.2 Metric Information</h3>
