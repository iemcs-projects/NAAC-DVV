...
const Criteria6_2_1 = () => {
  const [metrics, setMetrics] = useState([
    {
      id: '6.2.1',
      description: 'Describe one activity successfully implemented based on the strategic plan within a maximum of 500 words',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">6.2.1 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              The institutional Strategic/ perspective plan is effectively deployed</p>
            <h4 className="text-blue-600 font-medium mb-2">Required Documents:</h4>
            <ul className="list-disc pl-6 text-sm text-gray-700 space-y-1">
              
              <li>Strategic Plan and deployment documents on the website</li>
