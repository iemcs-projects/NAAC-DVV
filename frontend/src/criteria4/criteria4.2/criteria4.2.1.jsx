      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">4.2.1 Metric Information</h3>
                ...
                {metric.isExpanded && (
                  <div className="p-4 border-t">
                    ...
                    <textarea
                      ...
                      placeholder="Data Requirement for last five years: Upload a description of library with,
