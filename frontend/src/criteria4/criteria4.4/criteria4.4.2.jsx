...
const Criteria4_4_2 = () => {
  const [metrics, setMetrics] = useState([
    {
      id: '4.4.2',
      description: 'There are established systems and procedures for maintaining and utilizing physical, academic and support facilities - laboratory, library, sports complex, computers, classrooms etc. ',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-gray-800">Criterion 4 - Infrastructure and Learning Resources</h2>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">4.4.3 Metric Information</h3>
...
sports complex, computers, classrooms etc. </p>
          ...
          <div className="mt-auto bg-white border-t border-gray-200 shadow-inner py-4 px-6 flex justify-between items-center">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="px-4 py-2 shadow-sm text-sm rounded-md text-white !bg-blue-600 hover:!bg-blue-600"
              >
