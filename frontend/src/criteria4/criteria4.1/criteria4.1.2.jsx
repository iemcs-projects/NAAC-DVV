...
const Criteria4_1_2 = () => {
  const [metrics, setMetrics] = useState([
    {
      id: '4.1.2',
      description: 'The Institution has adequate facilities for cultural activities, sports, games (indoor, outdoor), gymnasium, yoga centre etc. ',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
  ...
  const gotoNextPage=()=>{
    navigate('/criteria4.1.3')
  }
  const gotoPreviousPage=()=>{
    navigate('/criteria4.1.1')
  }
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">4.1.2 Metric Information</h3>
...
establishment and user rate within a maximum of 500 words  </p>
...
/>
          ...
          {/* </div> */}
            ...
            <div className='mt-auto bg-white border-t border-gray-200 shadow-inner py-4 px-6'>
              <Bottom onNext={gotoNextPage} onPrevious={gotoPreviousPage}></Bottom>
            </div>
          </div>
        </div>
      </div>
