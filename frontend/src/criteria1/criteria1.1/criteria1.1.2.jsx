...
const Criteria1_1_2 = () => {
  const [metrics, setMetrics] = useState([
    {
      id: '1.1.2',
      description: 'The institution adheres to the academic calendar including for the conduct of CIE ',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex mt-6 flex-1">
        ...
        <div className="flex-1 flex mt-6 flex-col p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">1.1.2 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
             The institution adheres to the academic calendar including for the conduct of CIE</p>
            <h4 className="text-blue-600 font-medium mb-2">Requirements:</h4>
            <ul className="list-disc pl-6 text-sm text-gray-700 space-y-1">
              <li>Write description in not more than 500 words 
 </li>
