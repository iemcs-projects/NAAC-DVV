...
const Criteria1_1_1 = () => {
  ...
  const goToPreviousPage = () => {
    navigate('/criteria1.1'); // Or whatever the previous page should be
  };
      ...
      <div className="flex flex-1 overflow-hidden pt-8">
        ...
        <div className={`flex-1 transition-all duration-300 overflow-y-auto ${isSidebarCollapsed ? 'ml-16' : 'ml-64'} pl-6 pr-6`}>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">1.1.1 Metric Information</h3>
          ...
          <div className="flex-1">
                ...
                {metric.isExpanded && (
                  <div className="p-4 border-t">
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Description of Initiatives <span className="text-red-500">*</span>
                    </label>
                    <textarea
                      ref={el => (textareaRefs.current[metric.id] = el)}
                      value={metric.response}
                      onChange={e => handleResponseChange(metric.id, e.target.value)}
                      placeholder="Enter description of initiatives here (maximum 500 words)..."
                      ...
                      <span>
                        {metric.wordCount > 500 ? (
                          <span className="text-red-600">
                            <i className="fas fa-exclamation-triangle mr-1"></i> Please keep within 500 words
                          </span>
                        ) : metric.wordCount === 0 ? (
                          <span className="text-amber-600">
                            <i className="fas fa-exclamation-triangle mr-1"></i> Please enter your description
                          </span>
                        ) : (
                          <span className="text-green-600">
                            <i className="fas fa-check-circle mr-1"></i> {500 - metric.wordCount} words remaining
                          </span>
                        )}
                      </span>
                      <span>
            ...
            <div className="mt-auto bg-white rounded-lg shadow-md p-6 mb-6">
              <div className="mb-6">
