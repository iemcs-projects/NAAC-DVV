...
const Criteria1_1_1 = () => {
  ...
  // Initialize current year and fetch existing uploads
  useEffect(() => {
        ...
        <div className={`flex-1 transition-all duration-300 overflow-y-auto ${isSidebarCollapsed ? 'ml-16' : 'ml-64'} pl-6 pr-6 `}>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <p className="text-sm text-gray-700 mb-4">
              The Institution ensures effective curriculum delivery through a well 
planned and documented process </p>
