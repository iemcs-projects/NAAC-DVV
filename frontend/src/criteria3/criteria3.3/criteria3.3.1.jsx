...
const Criteria3_3_1 = () => {
  ...
  const [metrics, setMetrics] = useState([
    {
      id: '3.3.1',
      description: 'Describe the impact of extension activities in sensitising students to social issues and holistic development within a maximum of 500 words. ',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex flex-1 overflow-hidden pt-8">
        ...
        <div className={`flex-1 transition-all duration-300 overflow-y-auto ${isSidebarCollapsed ? 'ml-16' : 'ml-64'} pl-6 pr-6 `}>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">3.3.1 Metric Information</h3>
...
impact thereof during the last five years </p>
