...
const Criteria2_6_1 = () => {
  const [metrics, setMetrics] = useState([
    {
      id: '2.6.1',
      description: 'Teachers and students are aware of the stated Programme and course outcomes of the Programmes offered by the institution.',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
        ...
        <div className="flex-1 mt-6 flex flex-col p-4">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-sm text-gray-600">
              <span className="text-gray-600 mr-6">2.6 Student Performance and Learning Outcome </span>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">2.6.1 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              Teachers and students are aware of the stated Programme and course outcomes of the Programmes offered by the institution. </p>
...
<li>File Description:Past link for Additional information</li>
<li>File Description:Upload COs for all courses (exemplars from Glossary)</li>
            </ul>
          </div>
