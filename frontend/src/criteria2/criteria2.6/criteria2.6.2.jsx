...
const Criteria2_6_2 = () => {
  const [metrics, setMetrics] = useState([
    {
      id: '2.6.2',
      description: ' Attainment of Programme outcomes and course outcomes are evaluated by the institution </p>',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex mt-6 flex-1">
        ...
        <div className="flex-1 mt-6 flex flex-col p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">2.6.2 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              Attainment of Programme outcomes and course outcomes are evaluated by the institution </p>
...
<li>File Description:Paste link for Additional information</li>
            </ul>
          </div>
