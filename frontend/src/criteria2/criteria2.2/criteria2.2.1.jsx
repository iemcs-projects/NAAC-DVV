...
const Criteria2_2_1 = () => {
  ...
  const [metrics, setMetrics] = useState([
    {
      id: '2.2.2',
      description: 'The institution assesses the learning levels of the students and organises special Programmes for advanced learners and slow learners',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
        ...
        <div className="flex-1 mt-6 flex flex-col p-4">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-sm text-gray-600">
              <span className="text-gray-600 mr-6">2.2. Catering to Student Diversity </span>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">2.2.1 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              The institution assesses the learning levels of the students and organises special Programmes for advanced learners and slow learners </p>
