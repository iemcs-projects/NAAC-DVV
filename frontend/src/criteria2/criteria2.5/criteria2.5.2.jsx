...
const Criteria2_5_2 = () => {
  const [metrics, setMetrics] = useState([
    {
      id: '2.5.2',
      description: 'Mechanism to deal with internal examination related grievances is transparent, time- bound and efficient',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
        ...
        <div className="flex-1 mt-6 flex flex-col p-4">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-sm text-gray-600">
              <span className="text-gray-600 mr-6">2.5. Evaluation Process and Reforms </span>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">2.5.2 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              Mechanism to deal with internal examination related grievances is transparent, time- bound and efficien </p>
          ...
          <div className="flex-1">
           ...
           <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
              <li>File Description:Any additional information
</li>
