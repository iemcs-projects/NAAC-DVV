        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center h-[70px] w-[700px] shadow border border-black/10 rounded-2xl hover:shadow-lg transition-shadow duration-300">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">2.3 Teaching-Learning Process</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">2.3.2 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              Teachers use ICT enabled tools for effective teaching-learning process. </p>
...
<li>File Description:Provide link for webpage describing the ICT enabled tools for effective teaching-learning process</li>
            </ul>
          </div>
