      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">7.1.11 Metric Information</h3>
                ...
                >
                  <div>
                    ...
                    <div className="text-sm text-gray-500 mt-1">
                      {metric.mandatory ? <span className="text-red-600">Mandatory</span> : null}
                      {metric.lastSaved && (
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <div className="bg-blue-50 p-4 rounded-md mb-6">
              <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
                <li>Provide Web link to: Annual report of the celebrations and commemorative events for the last five years</li>
                <li>Provide Web link to: Geotagged photographs of some of the events</li>
