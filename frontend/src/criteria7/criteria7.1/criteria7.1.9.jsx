      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">7.1.9 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              Sensitization of students and employees of the Institution to the constitutional obligations: values, rights, duties and responsibilities of citizens </p>
          ...
          <div className="flex-1">
           ...
           <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
              <li>Provide Web link to:Details of activities that inculcate values; necessary to render students in to responsible citizens
</li>
