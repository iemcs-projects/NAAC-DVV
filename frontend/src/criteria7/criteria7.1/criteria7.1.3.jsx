...
const Criteria7_1_3 = () => {
  const [metrics, setMetrics] = useState([
    {
      id: '7.1.3',
      description: 'Describe the facilities in the Institution for the management of the following types of degradable and non-degradable waste ',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">7.1.3 Metric Information</h3>
...
Hazardous chemicals and radioactive waste management </p>
          ...
          <div className="flex-1">
           ...
           <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
              <li>Relevant documents like agreements/MoUs with Government and other approved agencies
</li>
              
<li>Geotagged photographs of the facilities   </li>
