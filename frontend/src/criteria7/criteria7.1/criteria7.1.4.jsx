      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="bg-white p-6 rounded shadow mb-6">
            <h3 className="text-blue-600 font-semibold mb-2">7.1.4 Metric Information</h3>
            <p className="text-sm text-gray-700">
              Water conservation facilities available in the Institution:<br />
              1. Rain water harvesting<br />
              2. Borewell / Open well recharge<br />
              3. Construction of tanks and bunds<br />
              4. Waste water recycling<br />
