      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="bg-white p-6 rounded shadow mb-6">
            <h3 className="text-blue-600 font-semibold mb-2">7.1.7 Metric Information</h3>
            <p className="text-sm text-gray-700">
              The Institution has disabled-friendly, barrier free environment:<br />
              1. Built environment with ramps/lifts for easy access to classrooms<br />
              2. Disabled-friendly washrooms<br />
              3. Signage including tactile path, lights, display boards and signposts<br />
              4. Assistive technology and facilities for persons with disabilities (Divyangjan): accessible website, screen-reading software, mechanized equipment<br />
          ...
          <div className="bg-white p-6 rounded shadow mb-6">
            <ul className="list-disc text-sm text-gray-700 mb-4 pl-5">
              ...
              <li>Upload: Policy documents and information brochures on the support to be provided</li>
              <li>Upload: Details of the Software procured for providing the assistance</li>
