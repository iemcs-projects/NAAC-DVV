      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">7.1.1 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              Measures initiated by the Institution for the promotion of gender equity during the last five years. </p>
          ...
          <div className="flex-1">
           ...
           <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
              <li>Annual gender sensitization action plan
</li>
              
<li>Specific facilities provided for women in terms of:
a) Safety and security
b) Counselling
c) Common Rooms
d) Day care center for young children
e) Any other relevant information</li>
            </ul>
          </div>
