        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-sm text-gray-600">
              <span className="text-gray-600 mr-6">7.1-Institutional Values and Social Responsibilities </span>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">7.1.8 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              Describe the Institutional efforts/initiatives in providing an inclusive environment i.e., tolerance and harmony towards cultural, regional, linguistic, communal socioeconomic and other diversities </p>
          ...
          <div className="flex-1">
           ...
           <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
              <li>Provide Web link to:Supporting documents on the information provided (as reflected in the administrative and academic activities of the Institution)
</li>
