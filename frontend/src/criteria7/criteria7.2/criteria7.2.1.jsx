        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-sm text-gray-600">
              <span className="text-gray-600 mr-6">7.2-Best Practices </span>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">7.2.1 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
              Describe two best practices successfully implemented by the Institution as per NAAC format provided in the Manual. </p>
          ...
          <div className="flex-1">
           ...
           <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
              <li>Provide web link to:Annual gender sensitization action plan
</li>
              
<li>Provide web link to:Best practices in the Institutional web site</li>
            </ul>
          </div>
