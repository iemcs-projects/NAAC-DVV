      ...
      <div className="flex w-full">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div className="mb-4">
              <h3 className="text-blue-600 font-medium mb-2">5.2.2 Metric Information</h3>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc pl-5 text-sm text-gray-700">
                <li>Details of student progression to higher education</li>

<li>Upload supporting data for student/alumni</li> 
            ...
            <table className="w-full border text-sm border-black">
              <thead className="bg-gray-100 text-gray-950">
                <tr>
                  ...
                  <th className="border px-2 py-2">Name of student enrolling into higher
education
 </th>
                  <th  className="border px-2 py-2">Program graduated from  </th>
                
<th  className="border px-2 py-2">Name of institution joined</th>
<th  className="border px-2 py-2">Name of programme admitted to
                ...
                <table className="w-full text-sm border">
                  ...
                  <tr>
                      ...
                      <th  className="border text-gray-950 px-4 py-2">Year</th>
                       <th  className="border text-gray-950 px-4 py-2">Name of student enrolling into higher
education
</th>
                      <th  className="border text-gray-950 px-4 py-2">Program graduated from</th>
                      <th  className="border text-gray-950 px-4 py-2">Name of institution joined </th>
                      <th  className="border text-gray-950 px-4 py-2">Name of programme admitted to</th>
                    </tr>
                  ...
                  <tbody>
                    {yearData[year].map((entry, index) => (
                      <tr key={index} className="even:bg-gray-50">
                        ...
                        <td className="border text-gray-950 px-2 py-1">{entry.institution}</td>
                        <td className="border text-gray-950 px-2 py-1">{entry.pname}</td>
