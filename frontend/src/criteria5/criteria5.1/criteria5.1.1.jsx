...
freeships provided by the Government 
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc pl-5 text-sm text-gray-700">
                <li>Upload self attested letter with the list of students sanctioned 
scholarship </li>

<li>Average percentage of students benefited by scholarships and 
freeships provided by the Government during the last five years</li> 
                </ul>
            </div>
          </div>
          ...
          <div className="border rounded mb-8">
            <div className="flex justify-between items-center bg-blue-100 text-gray-800 px-4 py-2">
              <h2 className="text-xl font-bold">Students benefited by scholarships and 
freeships provided by the Government </h2>
              <div className="size-7 mb-1">
                <label className="text-gray-700 font-medium mr-2 -ml-[370px]">Select Year:</label>
                <select
                  value={selectedYear}
