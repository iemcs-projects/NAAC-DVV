...
const Criteria5_3_2 = () => {
  const [metrics, setMetrics] = useState([
    {
      id: '5.3.2',
      description: 'Institution facilitates students’ representation and engagement in various administrative, co-curricular and extracurricular activities (student council/ students representation on various bodies as per established processes and norms )',
      response: '',
      wordCount: 0,
      isComplete: false,
      isExpanded: true,
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-gray-800">Criteria 5: Student Support and Progression</h2>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-blue-600 font-medium mb-2">5.3.2 Metric Information</h3>
            <p className="text-sm text-gray-700 mb-4">
             Institution facilitates students’ representation and engagement in various administrative, co-curricular and extracurricular activities (student council/ students representation on various bodies as per established processes and norms ) </p>
          ...
          <div className="flex-1">
           ...
           <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
              <li>Paste link for additional information

</li>
              <li>Upload any additional information
</li>
            </ul>
          </div>
