...
router.route('/score121')
    .get(verifyToken, checkAccess('score121'), score121);

// Criteria 1.2.2 & 1.2.3 routes - Faculty only (shared controllers)
router.route('/createResponse122_123')
    .post(verifyToken, checkAccess('createResponse122_123'), createResponse122_123);

router.route('/updateResponse122_123/:sl_no')
    .put(verifyToken, checkAccess('updateResponse122_123'), updateResponse122_123);

router.route('/deleteResponse122_123/:sl_no')
    .delete(verifyToken, checkAccess('deleteResponse122_123'), deleteResponse122_123);

router.route('/score122')
    .get(verifyToken, checkAccess('score122'), score122);
    
router.route('/score123')
    .get(verifyToken, checkAccess('score123'), score123);

// Criteria 1.3.2 routes - Faculty only
router.route('/createResponse132')
    .post(verifyToken, checkAccess('createResponse132'), createResponse132);

router.route('/updateResponse132/:sl_no')
    .put(verifyToken, checkAccess('updateResponse132'), updateResponse132);

router.route('/deleteResponse132/:sl_no')
    .delete(verifyToken, checkAccess('deleteResponse132'), deleteResponse132);

router.route('/score132')
    .get(verifyToken, checkAccess('score132'), score132);

// Criteria 1.3.3 routes - Faculty only
router.route('/createResponse133')
    .post(verifyToken, checkAccess('createResponse133'), createResponse133);

router.route('/updateResponse133/:sl_no')
    .put(verifyToken, checkAccess('updateResponse133'), updateResponse133);

router.route('/deleteResponse133/:sl_no')
    .delete(verifyToken, checkAccess('deleteResponse133'), deleteResponse133);

router.route('/score133')
    .get(verifyToken, checkAccess('score133'), score133);

// Criteria 1.4.1 routes - Faculty only
router.route('/createResponse141')
    .post(verifyToken, checkAccess('createResponse141'), createResponse141);

router.route('/updateResponse141/:sl_no')
    .put(verifyToken, checkAccess('updateResponse141'), updateResponse141);

router.route('/deleteResponse141/:sl_no')
    .delete(verifyToken, checkAccess('deleteResponse141'), deleteResponse141);

router.route('/score141')
    .get(verifyToken, checkAccess('score141'), score141);

// Criteria 1.4.2 routes - College Admin only
router.route('/createResponse142')
    .post(verifyToken, checkAccess('createResponse142'), createResponse142);

router.route('/updateResponse142/:sl_no')
    .put(verifyToken, checkAccess('updateResponse142'), updateResponse142);

router.route('/deleteResponse142/:sl_no')
    .delete(verifyToken, checkAccess('deleteResponse142'), deleteResponse142);

router.route('/score142')
    .get(verifyToken, checkAccess('score142'), score142);
